...
class TranscribeConfig:
    ...
    """Transcribe the whole file in one pass instead of slicing per diarization turn.
    Diarization turns are then used to label each entry's speaker by time overlap."""
